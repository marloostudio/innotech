      ...
      <PageShell>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {autolockFeatures.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="group bg-it-light-surface border border-it-light-border shadow-[var(--it-light-shadow-sm)] border-l-[3px] border-l-[var(--it-light-autolock)] hover:shadow-[var(--it-light-shadow-md)] transition-shadow">
                <CardHeader>
