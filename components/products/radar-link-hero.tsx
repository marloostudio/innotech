...
import { radarLinkProduct } from "@/lib/content/radar-link"
...
export function RadarLinkHero() {
  const prefersReducedMotion = useReducedMotion()
  const motionInitial = prefersReducedMotion ? "visible" : "hidden"

  return (
    <section className="it-hero-solutions relative pt-3 pb-8 lg:pt-4 lg:pb-10 lg:flex lg:flex-col lg:justify-center">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 xl:gap-16 items-center mx-6 lg:mx-10">
          ...
          >
            <motion.div className="inline-block mx-auto lg:mx-0 mb-2" variants={heroTextItemVariants}>
              <span className="inline-flex items-center rounded-full px-3 py-1 it-ribbon-badge font-medium bg-(--it-solutions-subtle) text-it-solutions">
                Product
              </span>
            </motion.div>
            <motion.h1
      ...
      <HeroScrollIndicator targetId="radar-link-overview" accent="solutions" />
    </section>
  )
}
