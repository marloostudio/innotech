...
export function HeroV2({ primaryCta, secondaryCta, background }: HeroV2Props) {
  return (
    <section className="relative w-full min-h-[60vh] pt-24 md:pt-28 pb-16 md:pb-20 overflow-hidden">
      ...
      <div className={`relative z-10 ${pageContainerClass}`}>
        <div className="flex flex-col items-center justify-center min-h-[calc(60vh-6rem)] text-center mx-auto max-w-[880px]">
          {/* Eyebrow / Tag Line */}
          <div
